...
clear
            ...
            echo $pur"  ║ ║║║║╠╣ ╠═╣║╣  ║║╠═╣╠═╣"
            echo $pur"  ╚═╝╝╚╝╚  ╩ ╩╚═╝═╩╝╩ ╩╩ ╩"
            echo $mer"  ×××Tool Unfaedah | By= Mr.Sinot $st"
...
echo ""
echo $mer " Tunggu Sekitar 3menit ya goblok $st"
echo ""
sleep 50
echo $cy " Sedang Mengambil Chat Terbaru goblok "
sleep 4
echo $bi " Chat Terbaru Dengan 'Widodo' "
echo $cy  " <Kemarin> "
echo ""
